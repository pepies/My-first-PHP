...
$doba = $_POST['doba']; //ako dlho bude expiť.
...
<?php
if($lvl<20){
echo "Naraz nemôžeš naexpiť viac ako 5 lvlov. Tak dávaj račšej kratší čas ked si zatial menší lvl.";
}
?>
</body>
</html>

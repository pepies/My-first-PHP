...
$pointy2  = $lvlpoint-$pocetint;
$noveinto = $int+$pocetint;
echo "<br>Ak ti ich nepridalo tak skús potlačiť F5.";
mysql_query("UPDATE users SET lvlpoint='$pointy2', intt='$noveinto' WHERE username='$username'") or die(mysql_error());
mysql_close();
?>
<script>
alert("Bolo pridaných <?php echo "$pocetinto"; ?> pointov do INT.");
location.replace("memberspage.php");
</script>
<?
}

...
<div id="telo">
  <?php
$velicina = $doba / $lvl;
$noveexp = $exp + $velicina;

$newgold = $doba/100*$lvl;
$novegold = $gold + newgold;

$query = "UPDATE users SET exp='$noveexp', gold='$novegold', doba='0' WHERE username='$username'";
$result = mysql_query($query);
if(!$result){
	echo "Smola :D nekde pri zápise do DB nastala chyba.";
	}else{
	echo "$velicina% Experience bolo pridané.<br>$newgold goldov bolo pridaných.";	}
mysql_close();
